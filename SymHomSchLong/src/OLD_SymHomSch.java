...
public final class SymHomSch {
 ...
 public BigInteger Dec3(BigInteger cipher, SHSParamters Param) {
    ...
    public BigInteger Add(BigInteger cipher1, BigInteger cipher2, SHSParamters Param)
    {
    	//Param is a public parameter(N)    	
    	return cipher1.add(cipher2).mod(Param.getParams().get(0));
    }

    public BigInteger Mul(BigInteger cipher1, BigInteger cipher2, SHSParamters Param)
    {
    	//Param is a public parameter(N)    	
    	return cipher1.multiply(cipher2).mod(Param.getParams().get(0));
    }

    public BigInteger Sub(BigInteger cipher1, BigInteger cipher2, SHSParamters Param)
    {
    	//Param is a public parameter(N)    	
